...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Leilão</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">{{\App\Http\Controllers\Admin\User::user()->name}}</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route("admin-lance")}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route("admin-arremate")}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route("admin-logs-admin")}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route("admin-logs-cliente")}}" class="nav-link">
